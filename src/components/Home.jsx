    ...
    <>
      <div className="flex flex-col items-center justify-center h-screen">
        ...
        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mt-8 mb-20">
          <button className="bg-btn1 hover:bg-hbtn1 text-white font-medium py-2 px-4 rounded focus:outline-none">
            Get started
          </button>
        </div>
      </div>

      <div className="container mx-auto my-12 mx-6 p-12 rounded-lg shadow-lg grid grid-cols-1 md:grid-cols-2 gap-8 h-auto md:h-screen">
        ...
        <div className="md:order-1 text-left">
          ...
          <p className="text-white mb-4 text-base sm:text-lg md:text-base lg:text-lg">
        ...
        <div className="md:order-4 text-left">
          <h2 className="text-4xl sm:text-2xl md:text-4xl text-mainText font-pixel font-bold mb-2 md:mb-4">
      ...
      <div className="container px-4 md:px-8 lg:px-16 xl:px-32 pb-8 pt-12 md:pt-16 lg:pt-20">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div className="shadow-lg rounded-3xl py-8 px-6 bg-mainAccent">
            ...
            <button className="bg-btn1 hover:bg-hbtn1 text-white font-medium py-2 px-6 w-full rounded focus:outline-none mt-6">
              Sign Up
            </button>
          </div>
          ...
          <div className="shadow-lg rounded-3xl py-8 px-6 bg-mainAccent">
            ...
            <h3 className="font-pixel font-bold text-mainText text-4xl sm:text-6xl mb-6 flex items-center">
              <BsCurrencyRupee className="text-2xl" /> 499
            </h3>
            <ul className="space-y-3">
              <li className="text-sm text-white flex items-center">
                <TiTick />
        ...
        <div className="container mt-8 p-4 md:p-8 lg:p-12">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-white leading-relaxed mb-8">
            Ready to get a head start on your financial future?
            <br />
            Sign up, it's time to watch your wealth grow!
          </p>
          <button className="bg-btn1 hover:bg-hbtn1 text-white font-medium py-2 px-4 sm:py-3 sm:px-6 rounded focus:outline-none">
            Start Now
          </button>
        </div>
